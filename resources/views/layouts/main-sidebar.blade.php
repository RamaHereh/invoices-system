        ...
        <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة')
                            ...
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'paid')) }}">الفواتير المدفوعة</a>
                        ...
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'unpaid')) }}">الفواتير
                                    الغير مدفوعة</a>
                            </li>
                        @endcan

                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'partially')) }}">الفواتير المدفوعة
                                جزئياً</a>
                            </li>
                        @endcan
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'reports_invoices')) }}">تقارير الفواتير</a>
                            </li>
                        @endcan

                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'reports_sections')) }}">تقارير العملاء</a>
                            </li>
                        @endcan
                    </ul>
                </li>
