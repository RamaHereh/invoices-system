...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الفواتير المدفوعة</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    الفواتير</span>
            </div>
        </div>
                ...
                <div class="card-header pb-0">
                    @can('اضافة فاتورة')
                        <a href="{{ route('invoices.create') }}" class="modal-effect btn btn-sm btn-primary"
                            style="color:white"><i class="fas fa-plus"></i>&nbsp; إضافة فاتورة</a>
                    @endcan
                    @can('تصدير EXCEL')
